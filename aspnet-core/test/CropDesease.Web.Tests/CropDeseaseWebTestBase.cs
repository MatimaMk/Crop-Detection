...
{
    public abstract class CropDeseaseWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static CropDeseaseWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(CropDeseaseWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<CropDeseaseDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<CropDeseaseDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<CropDeseaseDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<CropDeseaseDbContext, Task<T>> func)
        {
            T result;
